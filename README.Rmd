...
We now focus on the most recent Premier League season included in our study and replicate Figure 3 of [Varin and Firth (2024)](https://arxiv.org/abs/2406.09597):
```{r, warning = FALSE}
...
We conclude with Figure 4 from [Varin and Firth (2024)](https://arxiv.org/abs/2406.09597). Drawing this figure is more complicated than replicating previous figures due to the various annotations included:
```{r}
##~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
